...
namespace DemoLibrary
{
    public static class DataAccess
    {
        ...
        public static List<PersonModel> GetAllPeople()
        {
            ...
            output = FillPeopleList(content, output);

            return output;
        }

        public static List<PersonModel> FillPeopleList(string [] PeopleList , List<PersonModel> output)
        {
            foreach (string line in PeopleList)
            {
